...
//  Alert
//
//  Created by YangJeongMu on 1/6/25.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func btnLampOff(_ sender: UIButton) {
        if isLampOn {
            ...
            let offAction = UIAlertAction(title: "네", style: UIAlertAction.Style.default, handler: {ACTION in self.lamplmg.image = self.imgOff
                self.isLampOn = false
            })
